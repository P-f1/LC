...
@WiContrib({})
@Injectable()
export class CMLRunnerActivityContributionHandler extends WiServiceHandlerContribution {
    ...
    value = (fieldName: string, context: IActivityContribution): Observable<any> | any => {
		...
		console.log('[CMLRunner::value] Build field : ', fieldName);
		console.log(context);
    ...
    validate = (fieldName: string, context: IActivityContribution): Observable<IValidationResult> | IValidationResult => {
		...
		console.log('[CMLRunner::value] Validate field : ', fieldName);
