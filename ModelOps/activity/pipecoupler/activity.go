...
func (a *PipecouplerActivity) Eval(context activity.Context) (done bool, err error) {
	...
	log.Info("[PipecouplerActivity:Eval] entering ........ ")
	...
	log.Infof("Reply : ", reply)

	log.Info("[PipecouplerActivity:Eval] Exit ........ ")
...
func (a *PipecouplerActivity) getPipeline(context activity.Context) (PipeCouplerClient, error) {
	...
	if nil == client {
		...
		if nil == client {
			...
			log.Info("[PipecouplerActivity:getPipeline] downstreamHost = ", downstreamHosts)
