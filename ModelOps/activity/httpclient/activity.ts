...
@WiContrib({})
@Injectable()
export class HTTPClientActivityHandler extends WiServiceHandlerContribution {
    ...
    value = (fieldName: string, context: IActivityContribution): Observable<any> | any => {
		...
		console.log('[HTTPClientActivityHandler::value] Build field : ', fieldName);
    ...
    validate = (fieldName: string, context: IActivityContribution): Observable<IValidationResult> | IValidationResult => {
		console.log('[HTTPClientActivityHandler::value] Validate field : ', fieldName);
		return null; 
    }
}
