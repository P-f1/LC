...
import (
	...
	model "github.com/TIBCOSoftware/labs-flogo-lib/airmodel"
...
func (a *PipelineBuilderActivity) Eval(context activity.Context) (done bool, err error) {
	...
	**********************************/
	...
	log.Debug("[PipelineBuilderActivity:Eval]  Property Prefix : ", propertyPrefix)

	switch serviceType {
	case "k8s":
		descriptor[oF1Properties], _ = a.createK8sF1Properties(
			pathMapper,
			defVariable,
			propertyPrefix,
			appProperties,
	...
	default:
		descriptor[oF1Properties], _ = a.createDockerF1Properties(
			pathMapper,
			defVariable,
			propertyPrefix,
			appProperties,
